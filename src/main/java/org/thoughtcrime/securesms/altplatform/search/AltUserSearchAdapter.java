...
public class AltUserSearchAdapter extends RecyclerView.Adapter<AltUserSearchAdapter.ViewHolder> {
  ...
  public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
    ...
    String uname =
        profile.username != null && !profile.username.isEmpty() ? "@" + profile.username : "";
    holder.usernameLabel.setText(uname);
    holder.usernameLabel.setVisibility(
        uname.isEmpty() ? android.view.View.GONE : android.view.View.VISIBLE);
