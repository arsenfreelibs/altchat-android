...
/**
 * Restore Step 2: enter the email verification code. On success, moves to Step 3 (enter recovery
          ...
          Util.runOnMain(
              () -> {
                if (result == AltPlatformService.ResendResult.SUCCESS
                  ...
                  Toast.makeText(requireContext(), R.string.alt_code_resent, Toast.LENGTH_SHORT)
                      .show();
                  startCountdown();
                } else {
