...
/**
 * Restore Step 3: enter verification code + recovery password. Verifies the code, downloads the
 * encrypted private key, decrypts it, and imports into DC.
 */
              ...
              () -> {
                ...
                switch (result) {
                  ...
                  case INVALID_CODE:
                    ...
                    break;
                  case IMPORT_FAILED:
                    Toast.makeText(requireContext(), R.string.alt_import_failed, Toast.LENGTH_LONG)
                        .show();
                    break;
                  case NETWORK_ERROR:
                    Toast.makeText(
                            requireContext(),
                            R.string.network_connection_unavailable,
                            Toast.LENGTH_SHORT)
                        .show();
                    break;
                }
