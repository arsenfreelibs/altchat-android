...
public class AltPrefs {
  ...
  public static void setRegistered(Context context, String username, String email) {
    getPrefs(context).edit().putString(KEY_USERNAME, username).putString(KEY_EMAIL, email).apply();
  }
  ...
  public static void setPendingRegistration(
      Context context, String username, String displayName, String email) {
    getPrefs(context)
        .edit()
